...
## Algunas imágenes del proyecto
  <ol>
          ...
          <div className="flex flex-row justify-between flex-1"><div><h4>Creando las primeras cuentas</h4>
          <img src="./assets/PrimerInicio2.png" alt="Vista previa" width="500"/> 
          </div> <div>        <h4>Terminando las primeras configuraciones</h4>
          <img src="./assets/PrimerInicio3.png" alt="Vista previa" width="500"/></div>  </li>
